...
public class PersistentPropertyPathFactoryUnitTests {
	...
	public void returnsShortestsPathsFirst() {
		...
		assertThat(factory.from(First.class, it -> true) //
				.map(PersistentPropertyPath::toDotPath)).containsExactly("third", "second", "second.firstname");
	}
